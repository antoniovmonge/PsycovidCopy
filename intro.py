...
def app():
    ...
    col1.markdown('''
                  ####
                  The dataset contains demographic background variables as well as measures of Asian Disease Problem, 
                  ...
                  ####
                  ''')
    col1.image('images/map-1.png', width=400)
    ...
    col3.markdown('''
                  ...
                  ''')
    col3.image(['images/white-space-small.png', 'images/radar-chart.png'], use_column_width=False, width=140)
    col3.markdown('> and predict stress and loneliness levels based on your personaliy and some demographical factors')
    col3.image('images/speedometers-good.png', width=400)
